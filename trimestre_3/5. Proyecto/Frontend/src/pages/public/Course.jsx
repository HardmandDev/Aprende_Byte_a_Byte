    ...
    <>
      ...
      <article>
        <div className="container">
          <img src="https://upload.wikimedia.org/wikipedia/commons/6/6a/JavaScript-logo.png" alt="Images" className="centered-image" />
        </div>
        <Button className="button">
          <Link to="/auth/signup">Empezar Curso</Link>
        </Button>
