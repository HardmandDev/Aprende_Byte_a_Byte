// lesson.jsx:
// import {Header,Sidebar,MainContent} from "../components/auth/student/Lesson.jsx"
...
export const Sidebar = () => (
  <aside className="w-full lg:w-1/3 bg-gray-100 p-4 overflow-y-auto">
    <Tabs>
      ...
      <TabPanel>
        <h2 className="text-lg font-semibold mb-2 text-gray-800">Introducción a JavaScript</h2>
        ...
        <h3 className="text-md font-semibold mt-4  text-gray-800">Variables</h3>
        <p className='text-gray-800'>
        ...
        <pre className="bg-gray-200 p-2 mt-2 rounded  text-gray-800">
          <code>const a = 3;</code>
        </pre>
        <p className="mt-2 text-gray-800">
